...
def main():
    # 你的檔案路徑
    input_file = r"c:\Users\jimmy\OneDrive\桌面\台灣南島與新詞專題\新詞整合\新詞譯詞\01阿美語\merged_output.json" #改為你的檔案路徑
    # 修改輸出檔名為 .json
    output_file = r"c:\Users\jimmy\OneDrive\桌面\台灣南島與新詞專題\新詞整合\新詞譯詞\01阿美語\音節拆解.json"
